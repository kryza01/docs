...
This document explains how the genesis file of the KRYZA Diamond mainnet is structured. It also explains how you can build a genesis file for your own testnet.
...
```
"chain_id": "KRD-Chain-Tigris",
```
## Consensus Parameters

Next, the genesis file defines consensus parameters. Consensus parameters regroup all the parameters that are related to the consensus layer, which is `Tendermint` in the case of `KRYZA Diamond`. Let us look at these parameters:
...
The `tokens` module handles tokens. It contains the information of KRYZA Diamond native token `KRD`
```
