...
* Your full node has to run at least 4 hours per 24 hours in order to catch up with KRYZA Diamond More hours will be better, run your node continuously for best results.

## Setting Up a New Node
> You can skip this part if you have executed the install script.

First you need to choose a home folder `$BNCHOME` (i.e. ~/.bnbchaind) for KRYZA Diamond.
...
If those seeds aren't working, you can find more seeds and persistent peers in HTTP API endpoints: https://dex.kryzascan.com/api/v1/peers
