...
KRYZA Diamond CLI has a sub-command named `keys` to manage private keys.<br/>
...
KRYZA Diamond CLI use the keys you add to sign transactions for you.<br/>
For example, if you want to transfer tokens to someone else, you just need to specify the name of
the key you want to use, and input the password of the key, then KRYZA Diamond CLI will sign the
