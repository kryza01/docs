# KRYZA Diamond Transaction Encoding Specification

KRYZA Diamond transactions are protocol-based data types and can only be submitted in a compatible encoded frame.
