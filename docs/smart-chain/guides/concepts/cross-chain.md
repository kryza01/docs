...
A native cross chain communication protocol is developed between BC (KRYZA Diamond) and KRD (KRD Side Chain). It has the following key parts:

* [Build-in System Contract](system-contract.md)
* [Oracle on KRYZA Diamond](oracle-module.md)
* [NCRelayer](nc-relayer.md)
