...
Example: <https://testnet-explorer.kryzascan.com/token/0x68D2E27940CA48109Fa3DaD0D2C8B27E64a0c6cf>
...
Get API key: https://kryzascan.com/myapikey
...
- Verify
```
truffle run verify KRC20Token@{contract-address} --network testnet
```
You should see the following output:

```
Verifying KRC20Token@0x68D2E27940CA48109Fa3DaD0D2C8B27E64a0c6cf
Pass - Verified: https://testnet-explorer.kryzascan.com/address/0x68D2E27940CA48109Fa3DaD0D2C8B27E64a0c6cf#contracts
