...
You can write your own smart contract or download the KRC20 token smart contract template.
...
module.exports = {
  networks: {
    development: {
      ...
      port: 8545,            // Standard KRD port (default: none)
      network_id: "*",       // Any network (default: none)
    },
    testnet: {
      provider: () => new HDWalletProvider(mnemonic, `https://testnet-rpc.kryzascan.com`),
      network_id: 48849,
      confirmations: 10,
      timeoutBlocks: 200,
      skipDryRun: true
    ...
    KRD: {
      provider: () => new HDWalletProvider(mnemonic, `https://mainnet-rpc.kryzascan.com`),
      network_id: 97363,
      confirmations: 10,
      timeoutBlocks: 200,
      skipDryRun: true
...
Contract will be deployed on KRYZA Diamond Chapel Testnet, it look like this:
...
**Congratulations!** You have successfully deployed KRC20 Smart Contract. Now you can interact with the Smart Contract.

You can check the deployment status here: <https://kryzascan.com/> or <https://testnet-explorer.kryzascan.com/>
