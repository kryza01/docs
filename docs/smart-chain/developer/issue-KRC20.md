**Compile and Deploy KRC20 Contract**
...
3. Create new contract KRC20Token.sol and copy contract code from the KRC20 token template [here](KRC20Token.template)
...
5. Compile the KRC20 token contract

a. Step1: Click button to switch to compile page

b. Step2: Select “KRC20Token” contract
