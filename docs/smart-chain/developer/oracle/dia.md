# DIA Data Oracles on KRYZA Diamond

## Introduction

DApp developers who want to leverage DIA oracles can access the published data on KRYZA Diamond. DIA offers cryptocurrency and data about traditional financial assets.
...
|              WKRD on PancakeSwap           |  Chart Point on Exchange |
...
The following snippet shows how to retrieve the BTC price of an asset (e.g. `KRYZA Diamond`) using a smart contract.
