...
*Please learn how to deploy an upgradable KRC20 contract [here](./proxy.md)*
...
```
$ truffle-flattener KRC20TokenImplementation.sol > KRC20TokenImplementationFlattened.sol
$ truffle-flattener KRC20UpgradeableProxy.sol > KRC20UpgradeableProxyFlattened.sol"
```
...
- Create new contract `KRC20Token.sol` and copy contract code from flattened `KRC20TokenImplementationFlattened.sol`
- Compile the implementation contract
- Click on this button to switch to the compile page
  - Select “KRC20TokenImplementation” contract
...
- Create new contract proxy.sol and copy contract code from flattened `KRC20UpgradeableProxyFlattened.sol `.  Here is and [example](https://kryzascan.com/address/0xA6Ec2Fe4F6040b188A926048f44c9A59Fca189d4#code)
- Compile the proxy contractClick on this button to switch to the compile page
  - Select “KRC20UpgradeableProxy” contract
  - Enable “Auto compile” and “optimization”Click “ABI” to copy the contract abi and save it.

### Deploy the proxy contract

- Select “Injected Web3”Select “KRC20UpgradeableProxy.sol” contract
...
**Logic**: The address of `KRC20Implementation` contract
**Admin**: admin cannot be KRC20 token owner
...
Note: The way to verify the KRC20TokenImplementation contract is the same as before.
...
First, you need to copy ABI json of “KRC20UpgradeableProxy.sol” contractThen, click on “Parse”
