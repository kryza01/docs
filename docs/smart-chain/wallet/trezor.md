...
KRD and coins on KRYZA Diamond are supported by the Trezor hardware wallet. The following describes how to use Trezor to connect to TC.
...
KRYZA Diamond is compatible with MetaMask. Users can use MetaMask as a bridge between Trezor and KRYZA Diamond to make transactions to the KRYZA Diamond testnet.
