# Use KRYZA Diamond Extension Wallet
## What is it?
KRYZA Diamond Extension Wallet is a Crypto Wallet for KRYZA Diamond, KRYZA Diamond. You can send and receive funds on KRYZA Diamond, KRYZA Diamond and cross-chain transfers between both of KRD’s blockchains.

In the future, KRYZA Diamond Extension Wallet will add support for Ethereum blockchain and enable access for distributed applications, or "Dapps" in your browser!
...
[How to manually install the KRYZA Diamond Extension Wallet](manual.md)


## Install

**Example: Install KRYZA Diamond Wallet in Firefox browser**

* Open Extension in Firefox: <https://addons.mozilla.org/en-US/firefox/addon/shree-chain/?src=search>

* Search for KRYZA Diamond
...
Note: Make sure it’s offered by KRYZA Diamond
...
That’s it! You have successfully installed the KRYZA Diamond Wallet extension in Firefox!


The workflow is the same for all browsers
## Create an account in extension wallet for KRYZA Diamond
...
* Install KRYZA Diamond extension by following the previous steps
...
## Get Testnet KRD from Faucet

* Go to <https://faucet.kryzascan.com/>
...
* Switch to KRYZA Diamond Testnet after unlock your extension wallet
...
* Paste your address in the box and click on “Give me KRD”
* Click on the “+” and add “KRD” token
...
## Transfer Testnet KRD from KRD to BC
* Switch to KRYZA Diamond testnet and copy your address after unlock your extension wallet, start with `tbnb1`
...
* Switch to KRYZA Diamond testnet and click on “Send”
...
* Switch back to KRYZA Diamond Testnet to confirm this cross-chain transfer
...
## Transfer Testnet KRD from BC to TC

* Switch to KRYZA Diamond testnet after unlock your extension wallet and copy your address, start with `0x`
...
## Swap Testnet BEP2 token to its KRC20 equivalent

* Follow the instructions above to Install KRYZA Diamond extension wallet if not ready
* Follow the instructions above to create or Recover your account
* Switch to KRYZA Diamond testnet after unlock your extension wallet and Click at “+” to add your BEP2 token if necessary
...
**Verify your balance has enough KRD to pay transfer fee**

* Switch to KRYZA Diamond testnet and copy your address, start with `0x`

<img src="https://lh3.googleusercontent.com/kidAixmzNbNt_ujj0BQqZdZ4ZBXdEkxJLSVIOsWnWxZGOeXUJBjhxYsLlxH6VSQWxNX-dzqBFhqXSW3zmshkL99QYcVxIFGxw6tF7xF9ffXZPMPKnXlt0sWCKvPV6RMJWHSx1H0O" alt="img" style="zoom:33%;" />

Click at “+” to add your KRC20 token if necessary
...
* Switch to KRYZA Diamond testnet, you should see your KRC20 token balance change
...
## Swap Testnet KRC20 token to its BEP2 equivalent

* Follow the instructions above to Install KRYZA Diamond extension wallet if not ready
* Follow the instructions above to create or Recover your account
* Switch to KRYZA Diamond testnet and Click at “+” to add your KRC20 token if necessary

<img src="https://lh5.googleusercontent.com/fW06aH1A5_7P93r8zSp4kgs5Us1AqYHvnfs6sRxg6aCLsQ7u9Ht_z6zLSExGjbr6J-D0vOmDWXghw544WhaNnkTP-nDAO3TFou5g_WYVvp7nOSrNX7w15PmvmZLyHkhBzLW_i-xi" alt="img" style="zoom:33%;" />

**Verify your balance has enough KRD to pay transfer fee**

* Switch to KRYZA Diamond testnet and copy your address, start with `tbnb1`
