 ...
 * Function: *claim*
 * Parameters:
    * _swapID: this has been obtained from event, you can also calculate it from `calSwapID` function in the contract. calSwapID(randomNumberHash, {deputy ethereum address}, {hex encoding client shree address})
...
This is a javascript implementation of client app to swap  [PPC-00A](https://testnet-explorer.kryzascan.com/asset/PPC-00A) to [PPC](https://ropsten.etherscan.io/address/0xd93395b2771914e1679155f3ea58c41d89d96098) with deputy.
