...
There is no need to register. All you need is a KRYZA Diamond address, which can be generated with
...
## What is the current Fee Table on KRYZA Diamond Mainnet?
