...
```
$ eth-cli dex order  --symbol ZEBRA-16D_KRD  --side 1 --price 1000000 --qty 1000 --from guest  --chain-id KRD-Chain-Tigris   --node  https://dataseed5.defibit.io:443  -t gte
```
...
Msg [NewOrderMsg{Sender: 813E4939F1567B219704FFC2AD4DF58BDE010879, Id: 813E4939F1567B219704FFC2AD4DF58BDE010879-30, Symbol: ZEBRA-16D_KRD}] was sent.
```
...
```
eth-cli dex cancel --symbol ZEBRA-16D_KRD   --chain-id KRD-Chain-Ganges --node=data-seed-pre-2-s1.kryzascan.com:80 --refid  813E4939F1567B219704FFC2AD4DF58BDE010879-30 --from guest
```
...
```
eth-cli dex cancel --symbol ZEBRA-16D_KRD   --chain-id KRD-Chain-Tigris   --node  https://dataseed5.defibit.io:443 --refid  813E4939F1567B219704FFC2AD4DF58BDE010879-30 --from guest
```
...
```
eth-cli dex show -l ZEBRA-16D_KRD   --chain-id KRD-Chain-Ganges --node=data-seed-pre-2-s1.kryzascan.com:80
```
...
```
eth-cli dex show -l ZEBRA-16D_KRD    --chain-id KRD-Chain-Tigris   --node  https://dataseed5.defibit.io:443
```
